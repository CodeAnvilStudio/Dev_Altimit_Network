...
import com.altimit_server.types.Quaternion;
import com.altimit_server.types.Vector3;
...
public class AltimitConverter {
            ...
            for (Object params : args) {
                ...
                switch (type) {
                    ...
                    case "java.lang.String":
                        ...
                        break;
                    case "com.altimit_server.types.Vector3":
                        Vector3 castVector3 = (Vector3) params;
                        currentArr = convertToByteArray(castVector3);
                        break;
                    case "com.altimit_server.types.Quaternion":
                        Quaternion castQuaternion = (Quaternion) params;
                        currentArr = convertToByteArray(castQuaternion);
                        break;
                    default:
     ...
     */
    private static byte[] convertToByteArray(boolean value) {
    ...
    private static byte[] convertToByteArray(Vector3 value){
    ...
    private  static byte[] convertToByteArray(Quaternion value){
        ...
        for(int i = 0; i < array.length; i++){
            switch (array[i]){
                ...
                case 9:
                    ...
                    break;
                case 10:
                    paramaters.add(convertToVector3(Arrays.copyOfRange(array, i+1, i+13)));
                    i += 12;
                    break;
                case 11:
                    ...
                    break;
                default:
                    System.out.println("Conversion Case Invalid!");
                    i = array.length;
                    break;
            }
        }
     ...
     * @return Int value
     */
    private static Integer convertToInteger(byte[] array){
     ...
     */
    private static boolean convertToBoolean(byte array){
        return (Byte.toString(array) == "1");
    }

    private static Vector3 convertToVector3 (byte[] array){
        return new Vector3(ByteBuffer.wrap(array, 0, 4).getFloat(),
                ByteBuffer.wrap(array, 4, 4).getFloat(),
                ByteBuffer.wrap(array, 8, 4).getFloat());
    }

    private static Quaternion convertToQuaternion (byte[] array){
        return new Quaternion(ByteBuffer.wrap(array, 0, 4).getFloat(),
                ByteBuffer.wrap(array, 4, 4).getFloat(),
                ByteBuffer.wrap(array, 8, 4).getFloat(),
                ByteBuffer.wrap(array, 12, 4).getFloat());
    }
}
